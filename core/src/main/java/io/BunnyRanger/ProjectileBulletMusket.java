...
public class ProjectileBulletMusket extends ProjectileArrow {

    public ProjectileBulletMusket(WorldInstance world, float x, float y, float xSize, float ySize, float angle, Vector2 magnitude, float damage, float density, boolean friendly, boolean facingRight) {
